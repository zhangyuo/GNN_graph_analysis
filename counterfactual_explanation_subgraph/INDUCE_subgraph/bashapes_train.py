...
class SingleTrain(object):
    def __init__(self, args):
        ...
        if (self.dataset not in ['syn1', 'syn4', 'syn5', 'cora', 'chameleon', 'BA-SHAPES']):
...
if __name__ == "__main__":
    # --dataset BA-SHAPES --use_onehot --use_degree --use_entropy --ent 0.1 --policynet gat --maxbudget 5 --maxepisodes 10 --seed 102 --train_on_correct_only --k 4 --verbose --save_prefix inductive_non0_correct_only
    test_model = "GCN"
