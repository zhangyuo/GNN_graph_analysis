...
class SingleTrain(object):
    def __init__(self, args):
        ...
        if (self.args.train_on_non_zero):
            ...
            self.targets = torch.tensor(self.graph.idx_train).unsqueeze(1)
        self.players = []
        self.player_idx = []
        i = 0
...
if __name__ == "__main__":
    # --dataset Loan-Decision --use_onehot --use_degree --use_entropy --ent 0.1 --policynet gat --maxbudget 5 --maxepisodes 5 --seed 102 --train_on_correct_only --k 4 --verbose --save_prefix inductive_non0_correct_only
    test_model = "GCN"
