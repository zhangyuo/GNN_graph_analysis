...
if __name__ == "__main__":
    # --dataset Loan-Decision --use_onehot --use_degree --use_entropy --ent 0.1 --policynet gat --maxbudget 5 --seed 102 --k 4  --verbose --save_prefix inductive_non0_correct_only
    test_model = "GCN"
    ...
    weight_decay = 0.001
    with_bias = True
    test_nodes = [0, 1, 3, 6, 7, 9, 10, 12, 17, 21, 22, 23, 26, 28, 31, 34, 35, 39, 41, 42, 43, 45, 46, 47, 48, 49, 50, 52, 54, 56, 57, 62, 63, 65, 67, 79, 80, 81, 83, 84, 87, 88, 89, 90, 91, 93, 96, 98, 99, 100, 101, 102, 112, 114, 117, 118, 119, 122, 126, 131, 135, 139, 140, 141, 143, 146, 154, 157, 159, 161, 162, 165, 171, 175, 176, 177, 184, 187, 194, 195, 196, 197, 199, 201, 202, 205, 207, 209, 214, 217, 224, 225, 228, 229, 230, 234, 241, 242, 243, 244, 247, 249, 250, 252, 253, 256, 258, 259, 261, 262, 265, 269, 270, 274, 280, 285, 289, 292, 294, 296, 304, 308, 313, 320, 336, 337, 338, 342, 343, 344, 353, 354, 355, 356, 357, 358, 360, 363, 365, 366, 368, 375, 394, 402, 403, 411, 414, 416, 422, 424, 430, 431, 435, 441, 449, 458, 459, 468, 469, 472, 475, 478, 480, 485, 487, 493, 498, 500, 503, 509, 514, 516, 522, 526, 530, 532, 537, 542, 547, 550, 556, 561, 573, 578, 583, 586, 589, 592, 593, 597, 601, 605, 621, 624, 627, 635, 638, 639, 643, 649, 657, 661, 665, 671, 675, 685, 696, 698, 708, 720, 725, 728, 731, 736, 737, 741, 746, 753, 755, 759, 760, 762, 768, 774, 775, 780, 781, 783, 784, 786, 789, 790, 795, 802, 807, 810, 813, 815, 817, 821, 824, 827, 828, 831, 843, 847, 848, 860, 869, 870, 875, 878, 882, 893, 905, 907, 910, 927, 932, 938, 941, 945, 949, 954, 962, 965, 969, 971, 975, 977, 982, 984, 994]
    α2 = 1.5
    α3 = 1.0
    tau_c = 0
