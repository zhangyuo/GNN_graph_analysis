...
if __name__ == '__main__':
    ...
    for target_node in tqdm(target_node_list):
        ...
        attack_model = Nettack(surrogate, nnodes=adj.shape[0], attack_structure=True, attack_features=False)  # initialize the attack model
        attack_model = attack_model.to(device)
        attack_model.attack(features, adj, labels, target_node, n_perturbations=top_t)
