...
from source.src.GAT import load_GATNet_model
# import wandb
...
class SingleTrain(object):
    def __init__(self, args):
        ...
        file_path = f'../models/{test_model}/{dataset_name}/{gcn_layer}-layer/gat_model.pth'
        self.model = load_GATNet_model(file_path, _data["data"], nhid, dropout, device, lr, weight_decay, gcn_layer, heads_num)
