...
def generate_subgraph(attack_type, explanation_type, target_node_list, gnn_model, explainer, pyg_data, device,
    ...
    if attack_type == 'Evasion' and explanation_type == 'instance-level':
        ...
        with open(
                "/Users/***/Documents/PycharmProject/GNN_graph_analysis/results/2025-11-17_E-/subgraph_quantify/Evasion_GOttack_instance-level_GNNExplainer_cora_budget[5]/subgraph_data.pickle",
                "rb") as fr:
