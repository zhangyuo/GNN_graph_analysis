...
# dataset
DATA_NAME = "cora"  # ["cora", "BA-SHAPES", "TREE-CYCLES", "Loan-Decision", "chameleon", "ogbn-arxiv"]
...
EXPLAINER_METHOD = 'ACExplainer'  # ['GNNExplainer','PGExplainer','CFExplainer','ACExplainer','C2Explainer','INDUCE']
####################################################################
...
LAMBDA_PRED = 1.0  # Prediction loss weight GCN: 1.0, GT/GAT on cora:10.0
LAMBDA_DIST = 0.5  # Sparse term penalty weight 0.5
LAMBDA_PLAU = 0.5  # Realistic penalty weight 0.5
MAX_EDITS = 5  # Maximum disturbance budget
TAU_PLUS = 0.5  # Edge threshold GCN 0.5
TAU_MINUS = -0.5  # Edge reduction threshold GCN -0.5
α1 = 0  # Feature similarity penalty item weight 0
α2 = 1.5  # Degree change penalty item weight 1.5
α3 = 1.0  # Clustering coefficient change penalty term weight 1.0
α4 = 0  # Domain knowledge destruction penalty item weight 0
TAU_C = 0  # Clustering coefficient change tolerance threshold 0
